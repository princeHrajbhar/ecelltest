...
export interface TeamMemberFormData { // Export the interface
  memberName: string;
  memberId: string;
  description: string;
  email: string;
...
interface TeamMemberFormProps {
  existingMember?: TeamMemberFormData;
  onSubmit: (formData: TeamMemberFormData) => Promise<void>; // Use the defined type
...
const TeamMemberForm: React.FC<TeamMemberFormProps> = ({ existingMember, onSubmit, isSubmitting }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/members"); // Navigate to the members list after submitting
    } catch (error) {
          ...
          <div className="mb-8 flex flex-col items-center gap-4">
            ...
            {imagePreview && (
              <div className="relative">
                <Image src={imagePreview} alt="Image Preview" width={128} height={128} className="rounded-full object-cover mb-4" />
                <button
                  type="button"
